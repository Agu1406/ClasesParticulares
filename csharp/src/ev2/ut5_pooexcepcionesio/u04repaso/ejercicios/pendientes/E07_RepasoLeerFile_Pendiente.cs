/*
OBJETIVO: Repaso: leer "alumnos.txt" y mostrar cada nombre. Menu do-while: completar desde un menu interactivo con opcion 0 para salir.
...
public class Program
{
    ...
    static void EjecutarEjercicio()
    {
        File.WriteAllLines("alumnos.txt", new[] { "Ana", "Luis", "Sara" });
            ...
            // TODO: ReadAllLines y foreach para mostrar nombres.
    }
}
