...
$generosBD = []; //Array para guardar los géneros de la base de datos
...
if ($conexion === false) {
    ...
    if (!isset($_SESSION["id"])) {
        echo "¡Error! No has iniciado sesión, inicia sesión.";
        ...
        if ($_SERVER['REQUEST_METHOD'] != 'POST' || !isset($_POST['enviar'])) {
            ...
            if (empty($_POST)) {
                ...
                // Comprobamos que existe el campo generos
                if (!isset($_POST['generos']) || empty($_POST['generos'])) {
                    $errores[] = "No se han seleccionado géneros";
                    // Si no tengo un Array valido y lleno de generos, borro las cookies.
