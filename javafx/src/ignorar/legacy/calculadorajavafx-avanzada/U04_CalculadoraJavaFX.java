...
/**
 * Calculadora JavaFX en codigo (sin FXML) con eventos y hoja de estilos CSS.
 *
 * @author profesorado (codigo original IES Aguadulce)
 * @author Agustin. A. Marquez. Pina (adaptacion al repo)
 * @since 03/06/2026
 */
public class U04_CalculadoraJavaFX extends Application {
    //----------------------------------------------
    ...
    public void start(Stage escenario) throws Exception {
        ...
        escena.getStylesheets().add(
                U04_CalculadoraJavaFX.class.getResource("U04_calculadora.css").toExternalForm());
