...
function mkUt1Sub1() {
  return [
    ...
    ex("06-cliente-multiples-recursos", "Varios recursos", "Array con html, css, js; imprime cuántos recursos pide el cliente.", "length del array.", `const recursos = ["index.html","estilo.css","app.js"];\n// TODO`, `const recursos = ["index.html","estilo.css","app.js"];\nconsole.log("Recursos:", recursos.length);`),
