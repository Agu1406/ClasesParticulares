 ...
 * y compilamos). La línea {@code package} se explicará más adelante; de momento puedes ignorarla.</p>
 *
 ...
 * @since 03/06/2026
 */
public class U01_Programa1 {
    public static void main(String[] args) {
        System.out.println("¡Hola mundo! Esta es tu primera lección.");
    }
}
