...
/**
 * Tren_RESUELTO de la linea 6 que para en Concepcion.
 *
...
public class Tren_RESUELTO {
    ...
    public Tren_RESUELTO(int numero, int capacidad, String sentido) {
        this.numero = numero;
    ...
    public String toString() {
        return "Tren_RESUELTO " + numero + " (" + sentido + ") - " + ocupacion + "/" + capacidad + " plazas";
    }
}
