...
public class EstacionConcepcion_RESUELTO {
    ...
    public void registrarLlegadaPasajero(Pasajero_RESUELTO pasajero) {
        anden.add(pasajero);
    }
     ...
     */
    public int embarcarEnTren(Tren_RESUELTO tren) {
        int embarcados = 0;
