package ev3.ut6.u01herenciapolimorfismo.practicas.madriduaxsistemagestionbanco;
 ...
 *   <li>Lanzar {@link SaldoInsufienteException_SIN_RESOLVER} cuando no haya fondos.</li>
...
public class Main_SIN_RESOLVER {
    public static void main(String[] args) throws SaldoInsufienteException_SIN_RESOLVER {
        // Creamos las dos cuentas de banco, una con saldo "0", otra con saldo "-1".
        CuentaBancaria_SIN_RESOLVER cuentaBancariaSaldo0 = new CuentaBancaria_SIN_RESOLVER("ES0100000000000000000001");
        CuentaBancaria_SIN_RESOLVER cuentaBancariaSaldoN = new CuentaBancaria_SIN_RESOLVER("ES0100000000000000000002", -1);
        ...
        } catch (SaldoInsufienteException_SIN_RESOLVER exception) {
