...
public class CuentaBancaria_RESUELTO {
    ...
    /**
     * Constructor de la clase "CuentaBancaria_RESUELTO" que permite
     * abrir (instanciar) cuentas de banco con saldo en
     * "-1", recibe como argumentos el numero de cuenta
     * del cliente y un saldo.
     */
    public CuentaBancaria_RESUELTO(String numeroCuenta, double saldo) {
     ...
     * del cliente.
     */
    public CuentaBancaria_RESUELTO(String numeroCuenta) {
        this.numeroCuenta = numeroCuenta;
        this.saldo = 0;
    }
    ...
    public void retirarDinero(double cantidad) throws SaldoInsufienteException_RESUELTO {
        ...
        if (cantidad > saldo) {
            throw new SaldoInsufienteException_RESUELTO ("!Error! Saldo insuficiente, intente una cantida mas pequena");
        }
