 ...
 */
public class EmpleadoPorHoras_RESUELTO extends Empleado_SIN_RESOLVER {
    ...
    /**
     * Constructor de la clase EmpleadoPorHoras_RESUELTO.
     * 
     ...
     */
    public EmpleadoPorHoras_RESUELTO(String nombre, double salarioBase, int horasTrabajadas, double tarifaPorHora) {
        ...
        if (tarifaPorHora > 150) {
            throw new TarifaExcesivaException_RESUELTO("La tarifa por hora no puede superar los 150?");
        }
