...
public class BicicletaCarretera_RESUELTO extends Bicicleta_SIN_RESOLVER {
    private String tipo;

    public BicicletaCarretera_RESUELTO(int velocidades, int pulgadas, int peso, String tamanio, boolean estado, int precio, String tipo) {
