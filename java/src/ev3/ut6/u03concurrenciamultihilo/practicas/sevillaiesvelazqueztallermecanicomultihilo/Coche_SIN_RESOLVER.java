 ...
 */
public class Coche_SIN_RESOLVER implements Runnable {
    ...
    public Coche_SIN_RESOLVER(TallerMecanico_SIN_RESOLVER taller, int idCoche) {
        this.taller = taller;
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("Coche_SIN_RESOLVER " + idCoche + ": me interrumpieron");
