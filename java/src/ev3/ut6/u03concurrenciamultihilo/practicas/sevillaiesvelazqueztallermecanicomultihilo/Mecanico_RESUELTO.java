 ...
 */
public class Mecanico_RESUELTO implements Runnable {
    ...
    public Mecanico_RESUELTO(TallerMecanico_RESUELTO taller, int tiempoMinimoReparacion, int tiempoMaximoReparacion) {
        this.taller = taller;
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("Mecanico_RESUELTO: reparando coche " + idCoche + " (tardare " + tiempoReparacion + " ms)");
            ...
            System.out.println("Mecanico_RESUELTO: me interrumpieron, dejo de trabajar");
