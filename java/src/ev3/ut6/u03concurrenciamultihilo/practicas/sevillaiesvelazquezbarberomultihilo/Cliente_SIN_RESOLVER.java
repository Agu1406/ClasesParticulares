 ...
 */
public class Cliente_SIN_RESOLVER implements Runnable {
    // Referencia al objeto BarberShop_SIN_RESOLVER (monitor) donde el cliente intentara entrar
     ...
     */
    public Cliente_SIN_RESOLVER(BarberShop_SIN_RESOLVER barberia, int idCliente) {
