 ...
 */
public class Barbero_SIN_RESOLVER implements Runnable {
    // Referencia al objeto BarberShop_SIN_RESOLVER (monitor) donde el barbero trabaja
    private final BarberShop_SIN_RESOLVER barberia;
     ...
     * clientes.
     * @param barberia (Clase BarberShop_SIN_RESOLVER) barberia donde trabaja.
     * @param tiempoAtencion (int) tiempo en milisegundos que tarda en atender.
     */
    public Barbero_SIN_RESOLVER(BarberShop_SIN_RESOLVER barberia, int tiempoAtencion) {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                /*
                 * Utilizando "barberia" controlamos que el hilo de "Barbero_SIN_RESOLVER" se duerma
