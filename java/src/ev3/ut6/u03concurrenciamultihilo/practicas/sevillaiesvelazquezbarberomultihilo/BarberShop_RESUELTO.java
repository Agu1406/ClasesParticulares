 ...
 */
public class BarberShop_RESUELTO {
     ...
     */
    public BarberShop_RESUELTO(int capacidadSalaEspera) {
    ...
    public synchronized boolean intentarEntrar(int idCliente) throws InterruptedException {
        ...
        if (clientesEsperando >= capacidadSalaEspera) {
            System.out.println("Cliente_RESUELTO " + idCliente + " se va (sala llena: " + clientesEsperando + "/" + capacidadSalaEspera + ")");
            return false;
        }
        ...
        System.out.println("Cliente_RESUELTO " + idCliente + " entra (turno " + miTurno + "). Clientes esperando: " + clientesEsperando);
        ...
        System.out.println("Cliente_RESUELTO " + idCliente + " esta siendo atendido");
        return true;
    }
    ...
    public synchronized void salir(int idCliente) throws InterruptedException {
        ...
        System.out.println("Cliente_RESUELTO " + idCliente + " sale de la barberia");
