 ...
 */
public class Restaurante_RESUELTO {
    ...
    private List<Pedido_RESUELTO> pedidos; // Lista de pedidos

    /**
     * Constructor sin parametros de la clase Restaurante_RESUELTO
     */
    public Restaurante_RESUELTO() {
        this.nif = "";
        this.nombre = "";
    ...
    /**
     * Constructor de la clase Restaurante_RESUELTO
     * @param nombre Nombre del restaurante
     * @param nif NIF del restaurante
     */
    public Restaurante_RESUELTO(String nombre, String nif) {
        this.nombre = nombre;
        this.nif = nif;
        this.pedidos = new ArrayList<>();
        this.caja = 0;
    ...
    public boolean agregarpedido(Pedido_RESUELTO pedido) {
        ...
        pedidos.add(pedido);
        System.out.println("Pedido_RESUELTO agregado correctamente para el cliente " + pedido.getCliente().getNombre());
        return true;
    }
    ...
    public boolean cobrarpedido(String dni) {
        for (Pedido_RESUELTO pedido : pedidos) {
     ...
     * @param pedido Pedido_RESUELTO del que se emite la factura
     */
    private void emitirFactura(Pedido_RESUELTO pedido) {
        System.out.println("\n========================================");
        System.out.println("           FACTURA");
        System.out.println("========================================");
        System.out.println("Restaurante_RESUELTO: " + nombre);
        System.out.println("NIF: " + nif);
        System.out.println("Cliente_RESUELTO: " + pedido.getCliente().getNombre() + " (DNI: " + pedido.getCliente().getDni() + ")");
        System.out.println("----------------------------------------");
    ...
    public void mostrarPedidosCobrados() {
        ...
        List<Pedido_RESUELTO> pedidosCobrados = new ArrayList<>();
        for (Pedido_RESUELTO pedido : pedidos) {
            if (pedido.isEstado()) {
