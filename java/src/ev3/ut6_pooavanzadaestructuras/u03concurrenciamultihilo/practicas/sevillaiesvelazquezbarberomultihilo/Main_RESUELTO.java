 ...
 * <ul>
 *   <li>Crear la barberia como monitor y lanzar el hilo del {@link Barbero_RESUELTO}.</li>
 *   <li>Generar clientes ({@link Cliente_RESUELTO}) que compiten por las sillas disponibles.</li>
...
public class Main_RESUELTO {
    ...
    public static void main(String[] args) {
         ...
         */
        BarberShop_RESUELTO barberiaElias = new BarberShop_RESUELTO(CANTIDAD_SILLAS_SALA_ESPERA);

        /*
         * Creacion del objeto Barbero_RESUELTO que implementa Runnable.
         * Le pasamos la barberia donde trabajara y el tiempo que tarda en atender a cada cliente.
         */
        Barbero_RESUELTO barberoElias = new Barbero_RESUELTO(barberiaElias, TIEMPO_QUE_TARDA_EN_ATENDER);
         ...
         */
        Thread hiloBarbero = new Thread(barberoElias, "Barbero_RESUELTO");
        
        /*
         * Iniciamos el hilo del barbero. Esto hace que el metodo run() del objeto Barbero_RESUELTO
        ...
        for (int idCliente = 1; idCliente <= CLIENTES_QUE_SERAN_ATENTIDOS; idCliente++) {
            ...
            // Creacion de un nuevo objeto Cliente_RESUELTO (implementa Runnable)
            Cliente_RESUELTO cliente = new Cliente_RESUELTO(barberiaElias, idCliente);
            
            // Creacion del hilo asociado a este cliente
            Thread hiloCliente = new Thread(cliente, "Cliente_RESUELTO " + idCliente);
