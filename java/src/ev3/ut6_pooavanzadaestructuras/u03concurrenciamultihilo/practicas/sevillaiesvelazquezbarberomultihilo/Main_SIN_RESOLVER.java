 ...
 *
 * <p>Enunciado: {@code sevilla-iesvelazquez-barbero-dormilon.pdf} y
 * {@code sevilla-iesvelazquez-barbero-simulacro.pdf} (carpeta de la practica).</p>
 *
 ...
 * <ul>
 *   <li>Crear la barberia como monitor y lanzar el hilo del {@link Barbero_SIN_RESOLVER}.</li>
 *   <li>Generar clientes ({@link Cliente_SIN_RESOLVER}) que compiten por las sillas disponibles.</li>
...
public class Main_SIN_RESOLVER {
    ...
    public static void main(String[] args) {
         ...
         */
        BarberShop_SIN_RESOLVER barberiaElias = new BarberShop_SIN_RESOLVER(CANTIDAD_SILLAS_SALA_ESPERA);

        /*
         * Creacion del objeto Barbero_SIN_RESOLVER que implementa Runnable.
         * Le pasamos la barberia donde trabajara y el tiempo que tarda en atender a cada cliente.
         */
        Barbero_SIN_RESOLVER barberoElias = new Barbero_SIN_RESOLVER(barberiaElias, TIEMPO_QUE_TARDA_EN_ATENDER);
         ...
         */
        Thread hiloBarbero = new Thread(barberoElias, "Barbero_SIN_RESOLVER");
        
        /*
         * Iniciamos el hilo del barbero. Esto hace que el metodo run() del objeto Barbero_SIN_RESOLVER
        ...
        for (int idCliente = 1; idCliente <= CLIENTES_QUE_SERAN_ATENTIDOS; idCliente++) {
            ...
            // Creacion de un nuevo objeto Cliente_SIN_RESOLVER (implementa Runnable)
            Cliente_SIN_RESOLVER cliente = new Cliente_SIN_RESOLVER(barberiaElias, idCliente);
            
            // Creacion del hilo asociado a este cliente
            Thread hiloCliente = new Thread(cliente, "Cliente_SIN_RESOLVER " + idCliente);
