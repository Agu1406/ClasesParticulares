 ...
 */
public class Barbero_RESUELTO implements Runnable {
    // Referencia al objeto BarberShop_RESUELTO (monitor) donde el barbero trabaja
     ...
     * clientes.
     * @param barberia (Clase BarberShop_RESUELTO) barberia donde trabaja.
     * @param tiempoAtencion (int) tiempo en milisegundos que tarda en atender.
     */
    public Barbero_RESUELTO(BarberShop_RESUELTO barberia, int tiempoAtencion) {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                /*
                 * Utilizando "barberia" controlamos que el hilo de "Barbero_RESUELTO" se duerma
