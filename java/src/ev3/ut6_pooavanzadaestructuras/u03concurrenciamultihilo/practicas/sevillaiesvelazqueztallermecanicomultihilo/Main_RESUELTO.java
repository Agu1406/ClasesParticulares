 ...
 *
 * <p>Enunciado: {@code sevilla-iesvelazquez-taller-mecanico.pdf} (carpeta de la practica).</p>
 *
 * <p><b>Objetivo:</b> coordinar un mecanico y varios coches con hilos y aparcamiento limitado.</p>
 *
 * <p>Para ello, el programa debe:</p>
 * <ul>
 *   <li>Modelar el taller ({@link TallerMecanico_RESUELTO}) y el hilo del {@link Mecanico_RESUELTO}.</li>
 *   <li>Lanzar coches ({@link Coche_RESUELTO}) que esperan o son atendidos segun capacidad.</li>
...
public class Main_RESUELTO {
    ...
    public static void main(String[] args) {
        ...
        TallerMecanico_RESUELTO taller;
        Mecanico_RESUELTO mecanico;
        Thread hiloMecanico;
        Thread[] hilosCoches;
        int tiempoEspera;
        int idCoche;
        Coche_RESUELTO coche;
        Thread hiloCoche;
        
        System.out.println("=== Taller Mecanico_RESUELTO - Simulacion Multihilo ===");
        System.out.println();
        ...
        taller = new TallerMecanico_RESUELTO(CAPACIDAD_APARCAMIENTO);
        // Creamos el mecanico que trabajara en el taller
        mecanico = new Mecanico_RESUELTO(taller, TIEMPO_MINIMO_REPARACION, TIEMPO_MAXIMO_REPARACION);
        // Creamos el hilo donde correra el mecanico
        hiloMecanico = new Thread(mecanico, "Mecanico_RESUELTO");
        ...
        for (int i = 0; i < NUMERO_COCHES; i++) {
            ...
            coche = new Coche_RESUELTO(taller, idCoche);
            // Creamos el hilo donde correra este coche
            hiloCoche = new Thread(coche, "Coche_RESUELTO-" + idCoche);
