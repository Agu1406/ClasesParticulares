 ...
 */
public class TallerMecanico_RESUELTO {
    ...
    public TallerMecanico_RESUELTO(int capacidadAparcamiento) {
    ...
    public synchronized int esperarCoche() throws InterruptedException {
        ...
        while (cochesEsperando == 0) {
            ...
            System.out.println("Mecanico_RESUELTO: me duermo, no hay coches");
            // Esperamos hasta que alguien nos despierte con notify()
            wait();
        }
        
        System.out.println("Mecanico_RESUELTO: me despierto, hay trabajo");
        ...
        System.out.println("Mecanico_RESUELTO: reparando coche " + cocheId + " (quedan " + cochesEsperando + " esperando)");
    ...
    public synchronized boolean intentarEntrar(int idCoche) throws InterruptedException {
        ...
        if (cochesEsperando >= capacidadAparcamiento) {
            System.out.println("Coche_RESUELTO " + idCoche + ": me voy, el aparcamiento esta lleno");
            return false;
        }
        ...
        System.out.println("Coche_RESUELTO " + idCoche + ": entro al aparcamiento (hay " + cochesEsperando + " esperando)");
        ...
        System.out.println("Coche_RESUELTO " + idCoche + ": ya me estan reparando");
        return true;
    }
    ...
    public synchronized void esperarReparacion(int idCoche) throws InterruptedException {
        ...
        System.out.println("Coche_RESUELTO " + idCoche + ": reparacion terminada, me voy");
    ...
    public synchronized void terminarReparacion(int idCoche) {
        ...
        cocheEnReparacion = 0;
        System.out.println("Mecanico_RESUELTO: termine con el coche " + idCoche + " (quedan " + cochesEsperando + " esperando)");
