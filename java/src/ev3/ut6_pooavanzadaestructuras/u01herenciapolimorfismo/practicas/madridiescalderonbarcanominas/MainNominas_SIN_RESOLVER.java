 ...
 *
 * <p>Enunciado: {@code madrid-iescalderonbarca-nominas.pdf} y
 * {@code madrid-iescalderonbarca-practica-obligatoria-ra4.pdf} (carpeta de la practica).</p>
 *
 ...
 *   <li>Modelar empleados con herencia ({@link Empleado_SIN_RESOLVER} y subclases).</li>
 *   <li>Aplicar polimorfismo mediante la interfaz {@link Cobros_SIN_RESOLVER}.</li>
 ...
 */
public class MainNominas_SIN_RESOLVER {
    ...
    private static void altaEmpleado() {
        ...
        // Crear el empleado con la clase correspondiente (MozoAlmacen_SIN_RESOLVER, JefeSeccion_SIN_RESOLVER, etc.)
    ...
    private static void bajaEmpleado() {
        ...
        if (quitado) {
            System.out.println("Empleado_SIN_RESOLVER dado de baja.");
        } else {
