...
public class NominasApp_RESUELTO {
    ...
    private static void altaEmpleado() {
        ...
        System.out.println("5. Directivo_RESUELTO");
        ...
        if (nuevo != null) {
            EMPLEADOS.add(nuevo);
            System.out.println("Empleado_SIN_RESOLVER dado de alta correctamente.\n");
        } else {
    ...
    private static void bajaEmpleado() {
        ...
        if (encontrado != null) {
            ...
            System.out.println("Empleado_SIN_RESOLVER " + encontrado.getNombreCompleto() + " dado de baja.\n");
        } else {
