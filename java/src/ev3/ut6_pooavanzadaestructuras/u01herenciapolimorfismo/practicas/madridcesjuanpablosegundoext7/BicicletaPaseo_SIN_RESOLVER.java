...
public class BicicletaPaseo_SIN_RESOLVER extends Bicicleta_SIN_RESOLVER {
    private String tipo;

    public BicicletaPaseo_SIN_RESOLVER(int velocidades, int pulgadas, int peso, String tamanio, boolean estado, int precio, String tipo) {
