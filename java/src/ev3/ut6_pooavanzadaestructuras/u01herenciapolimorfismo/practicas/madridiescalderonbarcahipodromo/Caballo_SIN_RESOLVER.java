...
public class Caballo_SIN_RESOLVER {
    /*
    ...
    /**
     * Constructor que permite crear objetos del tipo "Caballo_SIN_RESOLVER" usando un
     * nombre y un dorsal (posicion).
     *
     * @param nombre (String) nombre del caballo.
     * @param posicion (int) dorsal del caballo.
     */
    public Caballo_SIN_RESOLVER(String nombre,int posicion){
