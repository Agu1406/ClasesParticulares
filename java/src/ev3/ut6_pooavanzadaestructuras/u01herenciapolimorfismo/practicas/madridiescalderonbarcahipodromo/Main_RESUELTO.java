 ...
 * <ul>
 *   <li>Representar cada caballo con {@link Caballo_RESUELTO} (nombre, dorsal, distancia, estado).</li>
...
public class Main_RESUELTO {
    ...
    public static void main(String[] args) {
        ...
        Caballo_RESUELTO[] establo = new Caballo_RESUELTO[5];
        establo[0] = new Caballo_RESUELTO("Rocinante", 1);
        establo[1] = new Caballo_RESUELTO("Babieca", 2);
        establo[2] = new Caballo_RESUELTO("Rufio", 3);
        establo[3] = new Caballo_RESUELTO("Alvaro", 4);
        establo[4] = new Caballo_RESUELTO("Rosado", 5);
        ...
        for (Caballo_RESUELTO caballoActual : establo) caballoActual.imprimirInformacion();
        System.out.println("Pulse ENTER para continuar");
        teclado.nextLine();
        teclado.nextLine();

        Caballo_RESUELTO ganador = null;
        while (ganador == null) {
            String[] mensajesCaidaEsteTramo = new String[5];
            int cuantasCaidasEsteTramo = 0;

            for (Caballo_RESUELTO caballoActual : establo) {
            ...
            if (ganador == null) {
                ...
                for (Caballo_RESUELTO caballoActual : establo) if (!caballoActual.isCaballoCaido()) cuantosSiguenEnPie++;
