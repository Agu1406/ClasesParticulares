...
public class EmpleadoPorHorasFactory_RESUELTO implements EmpleadoFactory_SIN_RESOLVER {
    @Override
    public Empleado_SIN_RESOLVER crearEmpleado(String nombre, double salarioBase, Object... params) {
        ...
        return new EmpleadoPorHoras_RESUELTO(nombre, salarioBase, horasTrabajadas, tarifaPorHora);
    }
} 
