 ...
 */     
public class EmpleadoAsalariado_SIN_RESOLVER extends Empleado_SIN_RESOLVER {
    // variable que guarda el salario anual 
    private double salarioAnual;

    /**
     * Constructor de la clase EmpleadoAsalariado_SIN_RESOLVER.
     * @param nombre El nombre del empleado.
     * @param salarioBase El salario base del empleado.
     * @param salarioAnual El salario anual del empleado.
     */
    public EmpleadoAsalariado_SIN_RESOLVER(String nombre, double salarioBase, double salarioAnual) {
        // Llamamos al constructor de la clase padre
        super(nombre, salarioBase);
        // Comprobamos que el salario anual no es negativo
        if (salarioAnual < 0) {
            // Si el salario anual es negativo, lanzamos una excepcion
            throw new SalarioInvalidoException_SIN_RESOLVER("El salario anual no puede ser negativo");
        }
