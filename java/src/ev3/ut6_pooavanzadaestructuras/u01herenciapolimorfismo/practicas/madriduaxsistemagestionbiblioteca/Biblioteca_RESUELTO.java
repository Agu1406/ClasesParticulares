...
public class Biblioteca_RESUELTO {
    private String nombre;
    private List<Libro_SIN_RESOLVER> catalogo;
    private List<Usuario_RESUELTO> usuarios;
    private List<Reserva_RESUELTO> reservas;
    private final int maxLibros;
    private final int maxUsuarios;

    public Biblioteca_RESUELTO(String nombre, int maxLibros, int maxUsuarios) {
        this.nombre = nombre;
    ...
    public void agregarUsuario(Usuario_RESUELTO usuario) {
    ...
    public boolean existeUsuario(Usuario_RESUELTO usuario) {
        return usuarios.contains(usuario);
    }

    public void reservarLibro(Usuario_RESUELTO usuario, Libro_SIN_RESOLVER libro, Date fechaInicio, Date fechaFin) {
        ...
        Reserva_RESUELTO nuevaReserva = new Reserva_RESUELTO(usuario, libro, fechaInicio, fechaFin);
        reservas.add(nuevaReserva);
    }

    public void mostrarReservasActivas() {
        System.out.println("=== Reservas Activas ===");
        for (Reserva_RESUELTO reserva : reservas) {
            System.out.printf("sistema_gestion_biblioteca.Usuario_RESUELTO: %s, sistema_gestion_biblioteca.Libro_SIN_RESOLVER: %s, Desde: %s, Hasta: %s%n",
    ...
    public void imprimirCatalogo() {
        System.out.println("=== Catalogo de la sistema_gestion_biblioteca.Biblioteca_RESUELTO ===");
