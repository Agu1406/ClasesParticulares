package ev3.ut9.pf.repaso;

/**
 * Repaso UT9 antes de los ejercicios finales.
 *
 * <p><b>Para que sirve este archivo?</b> Checklist de conceptos que deben estar claros
 * antes de {@code 05-repaso/ejercicios/}. No introduce concepto nuevo: ordena el repaso.</p>
 *
 ...
 * @since 03/06/2026
 */
public final class RepasoProgramacionFuncionalIntro {

    private RepasoProgramacionFuncionalIntro() {
    }
