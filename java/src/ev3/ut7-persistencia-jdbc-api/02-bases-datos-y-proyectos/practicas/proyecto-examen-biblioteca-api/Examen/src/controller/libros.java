...
public class libros {
    ...
    public static void insertar(String isbn, int autorId, int bibliotecaId, int paginas, String tipo, int anio) {
        try {
    ...
    public static void exportarCsv(String dni) throws Exception {
        ...
        System.out.println("CSV guardado en export/libros_autor_" + dni + ".csv");
    }
}
