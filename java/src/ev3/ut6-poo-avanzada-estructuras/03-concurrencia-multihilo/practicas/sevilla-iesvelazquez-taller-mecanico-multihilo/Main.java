 ...
 *   <li>Lanzar coches ({@link Coche}) que esperan o son atendidos segun capacidad.</li>
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Taller Mecanico - Simulacion Multihilo ===");
        System.out.println();
        ...
        hiloMecanico = new Thread(mecanico, "Mecanico");
