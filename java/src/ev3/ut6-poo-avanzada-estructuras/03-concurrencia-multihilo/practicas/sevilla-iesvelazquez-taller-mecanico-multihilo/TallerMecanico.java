...
public class TallerMecanico {
    ...
    public synchronized int esperarCoche() throws InterruptedException {
        ...
        while (cochesEsperando == 0) {
            ...
            System.out.println("Mecanico: me duermo, no hay coches");
            // Esperamos hasta que alguien nos despierte con notify()
            wait();
        }
        
        System.out.println("Mecanico: me despierto, hay trabajo");
        ...
        System.out.println("Mecanico: reparando coche " + cocheId + " (quedan " + cochesEsperando + " esperando)");
    ...
    public synchronized boolean intentarEntrar(int idCoche) throws InterruptedException {
        ...
        if (cochesEsperando >= capacidadAparcamiento) {
            System.out.println("Coche " + idCoche + ": me voy, el aparcamiento esta lleno");
            return false;
        }
        ...
        System.out.println("Coche " + idCoche + ": ya me estan reparando");
        return true;
    }
    ...
    public synchronized void esperarReparacion(int idCoche) throws InterruptedException {
        ...
        System.out.println("Coche " + idCoche + ": reparacion terminada, me voy");
    ...
    public synchronized void terminarReparacion(int idCoche) {
        ...
        cocheEnReparacion = 0;
        System.out.println("Mecanico: termine con el coche " + idCoche + " (quedan " + cochesEsperando + " esperando)");
