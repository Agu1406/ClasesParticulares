 ...
 */
public class Ejercicio4_BloquesStatic {
    private static final int MAX_INTERVALOS = 14;
    private static Intervalo[] intervalos = null;
    
    public Ejercicio4_BloquesStatic() {
        Ejercicio4_BloquesStatic.intervalos = new Intervalo[Ejercicio4_BloquesStatic.MAX_INTERVALOS];
    }
    
    static {
        Intervalo first = new Intervalo(2, 4);
        Ejercicio4_BloquesStatic.intervalos[0] = first;
        Intervalo aux = null;
        for (int i = 1; i < Ejercicio4_BloquesStatic.MAX_INTERVALOS; i++) {
            aux = Ejercicio4_BloquesStatic.intervalos[i - 1].copia();
            aux.desplazar(3);
            Ejercicio4_BloquesStatic.intervalos[i] = aux;
        }
    }
    
    public String toString() {
        StringBuilder sb = new StringBuilder();
        for (Intervalo i : Ejercicio4_BloquesStatic.intervalos) {
            sb.append(i + "\n");
        }
        return sb.toString();
    }
    ...
    public static void main(String[] args) {
        Ejercicio4_BloquesStatic ps = new Ejercicio4_BloquesStatic();
