package ev3.ut9_programacionfuncional.pf.u01lambda.practicas.valencianaepigtppsesion1;
 ...
 */
public class Sesion1CollectionsLambda_RESUELTO {
    ...
    public static void main(String[] args) {
         ...
         * ============================================================ */
        TaskManagerExampleResuelto.runInteractive();
    }
}
...
class TaskResuelto {
    ...
    public TaskResuelto(String description, int priority, boolean completed) {
...
// ---------------------------------------------------------------------------
// Example class: using lambdas on List<TaskResuelto> for an interactive manager
// ---------------------------------------------------------------------------
class TaskManagerExampleResuelto {
    ...
    public static void runInteractive() {
        ...
        List<TaskResuelto> tasks = createSampleTasks();
        boolean exit = false;
    ...
    // -----------------------------------------------------------------------
    private static List<TaskResuelto> createSampleTasks() {
        List<TaskResuelto> tasks = new ArrayList<>();
        tasks.add(new TaskResuelto("Buy milk", 2, false));
        tasks.add(new TaskResuelto("Finish report", 4, false));
        tasks.add(new TaskResuelto("Book flight tickets", 3, true));
        tasks.add(new TaskResuelto("Call the dentist", 1, false));
        tasks.add(new TaskResuelto("Prepare lecture slides", 5, false));
        return tasks;
    }
    ...
    // -----------------------------------------------------------------------
    private static void showTasks(List<TaskResuelto> tasks) {
        if (tasks.isEmpty()) {
    ...
    // -----------------------------------------------------------------------
    private static void addTask(Scanner sc, List<TaskResuelto> tasks) {
        ...
        tasks.add(new TaskResuelto(desc, priority, false));
        System.out.println("TaskResuelto added.");
    }

    // -----------------------------------------------------------------------
    // c) Mark a task as completed (by index)
    // -----------------------------------------------------------------------
    private static void markTaskAsCompleted(Scanner sc, List<TaskResuelto> tasks) {
        if (tasks.isEmpty()) {
        ...
        if (idx >= 0 && idx < tasks.size()) {
            TaskResuelto t = tasks.get(idx);
            tasks.set(idx, new TaskResuelto(t.getDescription(), t.getPriority(), true));
            System.out.println("TaskResuelto marked as completed.");
        } else {
    ...
    // -----------------------------------------------------------------------
    private static void removeCompleted(List<TaskResuelto> tasks) {
    ...
    // -----------------------------------------------------------------------
    private static void sortByPriorityAsc(List<TaskResuelto> tasks) {
    ...
    // -----------------------------------------------------------------------
    private static void sortByPriorityDesc(List<TaskResuelto> tasks) {
    ...
    // -----------------------------------------------------------------------
    private static void sortByDescriptionLength(List<TaskResuelto> tasks) {
    ...
    // -----------------------------------------------------------------------
    private static void markUrgent(List<TaskResuelto> tasks) {
        // TODO: use replaceAll with a lambda:
        //       - if priority >= 4 and the description does not start with "[URGENT] ",
        //         return a new TaskResuelto with "[URGENT] " + description.
    ...
    // -----------------------------------------------------------------------
    private static void showHighPriorityTasks(Scanner sc, List<TaskResuelto> tasks) {
        if (tasks.isEmpty()) {
            System.out.println("There are no tasks.");
            return;
        }
