 ...
 * @since 03/06/2026
 */
public class U01_ParadigmaFuncionalIntro {

    private U01_ParadigmaFuncionalIntro() {
    }

    public static void main(String[] args) {
        System.out.println("=== Principios del paradigma funcional ===");
        System.out.println("Funciones puras e inmutabilidad -> U01_FuncionesPurasyInmutabilidadIntro.java");
        System.out.println("Transparencia referencial        -> U01_TransparenciaReferencialIntro.java");
        System.out.println("Funciones de orden superior      -> U01_FuncionesOrdenSuperiorIntro.java");
        System.out.println("Monadas (Optional, Future)       -> U01_MonadasIntro.java");
        System.out.println("Currying                         -> U01_CurrificacionIntro.java");
        System.out.println("Recursion declarativa            -> U01_RecursionFuncionalIntro.java");
        System.out.println();
