package ev3.ut9_programacionfuncional.pf.u03optional.practicas.valencianaepigtppsesion3;
 ...
 */
public class Sesion3CompositionLazy_RESUELTO {
    ...
    public static void main(String[] args) {
        ...
        TruthTableLabResuelto lab = new TruthTableLabResuelto();
        lab.runLab();
    }
 ...
 */
class PersonResuelto {
    private final String name;
    private final int age;

    PersonResuelto(String name, int age) {
        this.name = name;
        this.age = age;
    }
