// Banco de preguntas teóricas - Pruebas libres 2021 (40 preguntas).
...
window.bancoExamenes.programacion2021 = [
  ...
  },
  {
    ...
    correcta: 0,
    explicacion:
      "En minúsculas: g-u-a-d-a-l-a-j-a-r-a. Cuenta solo a,e,i,o,u: hay 1 «u» y 5 «a» → 6. (11 es la longitud de la cadena, trampa habitual.)"
  },
  {
    numero: 15,
    enunciado:
  ...
  },
  {
    ...
    correcta: 0,
    explicacion:
      "Los métodos static no se polimorfizan: se resuelven por el tipo de la referencia en compilación. t.cantar() usa Tenor → \"fa\"; s.cantar() usa Cantante → \"la\". Salida: fa la."
  },
  {
    numero: 36,
    enunciado:
