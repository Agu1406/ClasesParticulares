// Pruebas libres 2025 — programacion2025 (DAW Web)
...
window.bancoExamenes.programacion2025 = [
  {
    "numero": 1,
    "enunciado": "Dado el siguiente fragmento de código, cuál es el resultado del comando java test 8 2\npublic class Test {\npublic static void main(String[] args) {\nint a = Integer.parseInt(args[0]);\nint b = Integer.parseInt(args[1]);\nif (a % b == 0) {\nSystem.out.println(\"Divisible\");\n} else {\nSystem.out.println(\"No divisible\");\n}\n}\n}",
    "opciones": [
      "Divisible",
      "No divisible",
  ...
  },
  {
    ...
    "opciones": [
      ...
      "1",
      "2",
      "El código da errores de compilación."
    ],
    "correcta": 2,
  ...
  },
  {
    ...
    "opciones": [
      ...
      "La compilación falla en la línea 5."
    ],
    "correcta": 1,
  ...
  },
  {
    ...
    "correcta": 0,
    "explicacion": "Traza: x=(5++)+(--6)=5+5=10; y=(--5)+(5++)=4+4=8; z=(++5)+(--6)=6+5=11. (El PDF original listaba otras cifras; la salida real en Java es esta.)"
  },
  {
    "numero": 18,
    ...
    "correcta": 0,
    "explicacion": "a==b y a==c son false (objetos distintos); +10, +1000, +10000 por equals → 11010. (Opciones del PDF sin 11010; aquí se corrige según JDK.)"
  },
  {
    "numero": 19,
    ...
    "correcta": 1,
    "explicacion": "La sobrecarga (overload) es mismo nombre y distinta firma: distinto número o tipos de parámetros (p. ej. void f(int) y void f(int,double))."
  },
  {
    "numero": 20,
  ...
  {
    "numero": 25,
    "enunciado": "¿Qué excepción se lanza cuando intentas escribir en un archivo de solo lectura utilizando FileOutputStream?",
    "opciones": [
  ...
  {
    "numero": 31,
    "enunciado": "¿Qué se producirá si intenta compilar y ejecutar el siguiente código, pero no hay ningún archivo llamado Data.txt en el directorio actual?\nimport java.io.*;\npublic class FileTest {\npublic static void main(String[] args) {\nFileTest ft = new FileTest();\nSystem.out.println(ft.readFile());\n}\npublic int readFile() {\ntry {\nFileReader fr = new FileReader(\"Data.txt\");\nfr.close();\n} catch (FileNotFoundException e) {\nSystem.out.println(\"File not found\");\nreturn -1;\n} catch (IOException e) {\nSystem.out.println(\"IOException occurred\");\n} finally {\nSystem.out.println(\"Finally block executed\");\n}\nreturn 0;\n}\n}",
    "opciones": [
  ...
  {
    "numero": 35,
    "enunciado": "¿Cuál será el resultado cuando intente compilar y ejecutar el código siguiente?\npublic class Conv {\npublic static void main(String[] args) {\nConv c = new Conv();\nint i = 10;\nString s = \"20\";\nc.amethod(i, s);\n}\npublic void amethod(int i, String s) {\ni += s;\nSystem.out.println(i);\n}\n}",
    "opciones": [
