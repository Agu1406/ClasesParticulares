 ...
 * obtener el array resultado de la suma de ambos (suma de elementos de la misma posicion).
 * 
...
public class Ejercicio1_Arrays_SumarArrays_RESUELTO {
    public static void main(String[] args) {
        ...
        // Bucle que recorre todas las posiciones de los arrays para sumar los elementos de la misma posicion
