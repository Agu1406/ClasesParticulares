 ...
 * 
 * Crea una funcion llamada multiplicarMatrices(int[][] A, int[][] B) que
 * devuelva la matriz resultante de multiplicar A por B (en ese orden).
 * 
 * Recuerda como funciona la multiplicacion de matrices:
 ...
 *    del mismo tamano, asi que el resultado tambien lo sera.
 *  - El elemento resultado[fila][columna] se calcula asi:
 ...
 * una buena forma de comprobar que la funcion esta bien hecha).
 * 
 * Otro ejemplo:
 * 
 * A =                B =                A ? B =
