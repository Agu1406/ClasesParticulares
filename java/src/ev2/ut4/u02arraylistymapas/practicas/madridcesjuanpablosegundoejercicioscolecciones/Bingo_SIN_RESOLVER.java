...
public class Bingo_SIN_RESOLVER {
    ...
    /**
     * Genera un carton de Bingo_SIN_RESOLVER con numeros aleatorios
     */
    ...
    /**
     * Verifica si el carton completo esta marcado (Bingo_SIN_RESOLVER completo)
    ...
    public void jugar() {
        ...
        // Simular el juego hasta que se complete el Bingo_SIN_RESOLVER
        while (!bingoCompletado) {
            ...
            // Verificar si se completo el Bingo_SIN_RESOLVER
            if (verificarBingo()) {
    ...
    public static void main(String[] args) {
        Bingo_SIN_RESOLVER juego = new Bingo_SIN_RESOLVER();
        juego.jugar();
    }
}
