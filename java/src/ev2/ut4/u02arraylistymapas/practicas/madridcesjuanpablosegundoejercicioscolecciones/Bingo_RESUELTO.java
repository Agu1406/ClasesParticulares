...
/**
 * Programa que simula un juego de Bingo_RESUELTO
...
public class Bingo_RESUELTO {
    ...
    /**
     * Genera un carton de Bingo_RESUELTO con numeros aleatorios
     */
    ...
    /**
     * Verifica si el carton completo esta marcado (Bingo_RESUELTO completo)
    ...
    public void jugar() {
        ...
        // Simular el juego hasta que se complete el Bingo_RESUELTO
        while (!bingoCompletado) {
            ...
            // Verificar si se completo el Bingo_RESUELTO
            if (verificarBingo()) {
    ...
    public static void main(String[] args) {
        Bingo_RESUELTO juego = new Bingo_RESUELTO();
        juego.jugar();
    }
}
