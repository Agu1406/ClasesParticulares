 ...
 *@since 1-1-2021
 */
public class Quiniela_SIN_RESOLVER {
	 ...
	 */
	public Quiniela_SIN_RESOLVER(String[] partido, char[] apuesta) {
	 ...
	 */
	public int comprobarApuestas(Quiniela_SIN_RESOLVER quiniela) {
		int numAciertos = 0;	
	 ...
	 * @param quiniela
	 */
	public void copiarPartidos(Quiniela_SIN_RESOLVER quiniela) {
	 ...
	 * @param quiniela
	 */
	public void copiarApuestas(Quiniela_SIN_RESOLVER quiniela) {
...
} // De la clase Quiniela_SIN_RESOLVER
