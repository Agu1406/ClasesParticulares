 ...
 */
public class Quiniela_RESUELTO {
	 ...
	 */
	public Quiniela_RESUELTO(String[] partido, char[] apuesta) {
	 ...
	 */
	public int comprobarApuestas(Quiniela_RESUELTO quiniela) {
		int numAciertos = 0;	
	 ...
	 * @param quiniela
	 */
	public void copiarPartidos(Quiniela_RESUELTO quiniela) {
	 ...
	 * @param quiniela
	 */
	public void copiarApuestas(Quiniela_RESUELTO quiniela) {
