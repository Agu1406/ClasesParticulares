package ev2.ut4_colecciones.u01arrays.practicas.madridiescalderonbarcaquinielas;
...
public class Quinielas_RESUELTO {
	 ...
	 */
	private Quiniela_RESUELTO[] quinielas;
	...
	private void rellenarQuinielaManual() {
		...
		quinielasJugadas++;
		quinielas[quinielasJugadas] = new Quiniela_RESUELTO();
	...
	private void seleccionarQuinielaActiva() {
		...
		System.out.println("(0 = Quiniela_RESUELTO oficial)");
	...
	private void mostrarPartidosyApuestas() {
		...
		if (quinielaActiva == 0) {
			System.out.println("Quiniela_RESUELTO oficial:");
		} else {
			System.out.println("Quiniela_RESUELTO " + quinielaActiva + ":");
		}
