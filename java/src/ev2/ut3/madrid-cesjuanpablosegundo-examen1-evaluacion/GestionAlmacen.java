...
/**
 * Clase para gestionar un almacén de productos
...
public class GestionAlmacen {
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("4. Mostrar número de productos diferentes");
    ...
    /**
     * Consulta la cantidad de un producto específico por su nombre
     */
    private static void consultarCantidad() {
        ...
        if (almacen.containsKey(nombre)) {
            ...
            System.out.println("No se encontró el producto '" + nombre + "' en el almacén.");
        }
    }
    
    /**
     * Muestra el número total de productos diferentes almacenados
     */
    private static void mostrarNumeroProductos() {
        ...
        if (numeroProductos == 0) {
            ...
            System.out.println("Número de productos diferentes almacenados: " + numeroProductos);
        }
    }
}
