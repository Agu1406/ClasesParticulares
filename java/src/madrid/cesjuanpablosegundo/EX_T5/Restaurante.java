...
public class Restaurante {
    ...
    public boolean agregarpedido(Pedido pedido) {
        ...
        pedidos.add(pedido);
        System.out.println("Pedido agregado correctamente para el cliente " + pedido.getCliente().getNombre());
        return true;
    }
     ...
     * @param pedido Pedido del que se emite la factura
     */
    private void emitirFactura(Pedido pedido) {
        ...
        System.out.println("Cliente: " + pedido.getCliente().getNombre() + " (DNI: " + pedido.getCliente().getDni() + ")");
        System.out.println("----------------------------------------");
