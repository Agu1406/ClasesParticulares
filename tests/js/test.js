            ...
            <div class="container">
                <div class="results-container">
                    <div class="results-card">
                        ...
                        <a href="../../tests/javafx/test-javafx.html" class="btn-retry">Intentar de nuevo</a>
    ...
    exportToPDF(correct, total, percentage, timeSpent, results) {
        ...
        const pdfContent = `
            <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 800px; margin: 0 auto;">
                <h1 style="color: ${color}; text-align: center; margin-bottom: 10px;">Resultados del Test</h1>
        ...
        const opt = {
            margin: [10, 10, 10, 10],
            filename: `resultados-test-javafx-${new Date().toISOString().split('T')[0]}.pdf`,
