            ...
            <div class="container">
                <div class="results-container">
                    <div class="results-card">
                        ...
                        <a href="../../tests/javafx/test-codigo-estudio.html" class="btn-retry">Intentar de nuevo</a>
                        <a href="../../tests/javafx/test-codigo.html" class="btn-retry" style="background: var(--primary-color); margin-left: 10px;">Probar modo examen</a>
    ...
    exportToPDF(correct, total, percentage, timeSpent) {
        ...
        const pdfContent = `
            <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 800px; margin: 0 auto;">
                <h1 style="color: ${color}; text-align: center; margin-bottom: 10px;">Resultados del Test: Completar Código (Modo Estudio)</h1>
        ...
        const opt = {
            margin: [10, 10, 10, 10],
            filename: `resultados-test-codigo-estudio-${new Date().toISOString().split('T')[0]}.pdf`,
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('question-card')) {
        ...
        let testManager;
        try {
            testManager = new TestManagerEstudio(questionsCodigo);
        } catch (error) {
