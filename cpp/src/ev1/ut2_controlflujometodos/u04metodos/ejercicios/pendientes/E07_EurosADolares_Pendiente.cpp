...
void ImprimirMenu() {
    cout << endl;
    cout << "=== E07 Euros A Dolares Pendiente ===" << endl;
...
int main() {
    ...
    do {
        ...
        switch (opcion) {
            case 1:
                cout << "Completa la funcion EurosADolares(double euros) usando tasa 1.08." << endl;
                cout << "Prueba preparada: EurosADolares(100)." << endl;
                cout << "Resultado actual del esqueleto: " << EurosADolares(100) << endl;
                break;
            case 0:
                cout << "Saliendo..." << endl;
                break;
